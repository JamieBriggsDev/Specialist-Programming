...
//			{
//				//Position data
//				m_data.m_team[i].m_bots[j].m_posX = (int16_t)DynamicObjects::GetInstance()->
//					GetBot(i, j).GetLocation().XValue;
//				m_data.m_team[i].m_bots[j].m_posY = (int16_t)DynamicObjects::GetInstance()->
...
//			MyDrawEngine::GetInstance()->WriteInt(Vector2D(0.0f + 20 * j, 0.0f),
//				m_data.m_team[i].m_bots[j].m_posX, MyDrawEngine::WHITE);
//		}
//	}
//}
//
...
//	//if (l_error = false)
//	//{
//	//	ErrorLogger::Writeln(L"Could not setup server!");
//
//	//}
//
//	return l_error;
...
//bool Network::Recieve()
//{
//	char l_buffer[sizeof(InitData)];
//	memset(&l_buffer, 0, sizeof(InitData));
//	memset(&m_data, 0, sizeof(InitData));
//
//	int l_addresLength = sizeof(m_serverAddress);
//	int recvLen = 0;
//	recvfrom(m_socket, l_buffer, sizeof(InitData), 0, 
//		(struct sockaddr*) &m_serverAddress, &l_addresLength);
//
//	char exit[] = "exit";
//	if (strcmp(l_buffer, exit) == 0)
...
//	}
//
//	memcpy(&m_data, &l_buffer, sizeof(InitData));
//}
//
//
//
